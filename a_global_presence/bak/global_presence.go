...
func (c *connHandler) createSession() *ssh.Session {
...
func main() {
	...
	locations := []string{"banglore","frankfurt", "amsterdam", "london", "singapore", "toronto", "newYork"}
	ipAddrs := []string{"142.93.210.167","139.59.156.58", "165.232.92.187", "165.232.36.78", "209.97.166.127", "142.93.149.190", "167.172.225.168"} // add the list of ip addresses here
	...
	for _, vps := range droplets {
		session := vps.createSession()
		vps.establishPresence(session)
	}
